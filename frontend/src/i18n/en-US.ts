...
export const enUS: Dict = {
  ...
  no: 'No',
  remark: 'Remark',
  selectUserGroup: 'Select permission group (optional)',
  userGroupHelpTitle: 'How it works',
  userGroupHelp1: 'Each user can be assigned to a permission group. The group determines which inbound device groups the user can use when creating forwarding rules.',
  userGroupHelp2: 'When "Allow All Groups" is on, users in this group can use any inbound group. When off, manually specify which inbound groups are allowed below.',
  userGroupHelp3: 'Before deleting a permission group, migrate its users to another group — otherwise those users will see no available inbound groups and the "Add Rule" button will be disabled.',
  userGroupHelp4: 'Users can only select inbound groups permitted by their permission group when creating rules.',
  allowedInboundGroupsLabel: 'Allowed Inbound Groups',
