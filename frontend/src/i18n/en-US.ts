...
export const enUS: Dict = {
  ...
  siteAnnouncementHint: 'Shown at the top of the dashboard and account page; empty hides it. Visible to signed-in users only. Supports **bold**, *italic*, `code`, [links](https://…) and - lists; only http/https links are accepted.',
